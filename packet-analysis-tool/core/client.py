...
class PacketSnifferClient:
    ...
    def process_raw_data(self, data) -> dict:
        ...
        try:
            ...
            if packet.haslayer(IP) or packet.haslayer(TCP):
                packet_obj = self.create_packet_object(ip_src, ip_dst, port_src, port_dst)
    ...
    def create_packet_object(self, ip_src=None, ip_dst=None, port_src=None, port_dst=None) -> dict:
